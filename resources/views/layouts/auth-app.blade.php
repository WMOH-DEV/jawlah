...
<head>
  ...
  <link rel="stylesheet" id="css-custom" href="{{asset('admin/assets')}}/css/login.css">
...
<!--
    ...
    to handle those dependencies through webpack. Please check out  {{asset('admin/assets')}}/_js/main/bootstrap.js for more info.

    If you like, you could also include them separately directly from the  {{asset('admin/assets')}}/js/core folder in the following
    order. That can come in handy if you would like to include a few of them (eg jQuery) from a CDN.

     {{asset('admin/assets')}}/js/core/jquery.min.js
     {{asset('admin/assets')}}/js/core/bootstrap.bundle.min.js
     {{asset('admin/assets')}}/js/core/simplebar.min.js
     {{asset('admin/assets')}}/js/core/jquery-scrollLock.min.js
     {{asset('admin/assets')}}/js/core/jquery.appear.min.js
     {{asset('admin/assets')}}/js/core/js.cookie.min.js
-->
