                    ...
                    <div class="col-md-8 d-flex align-items-center py-3">
                        <div class="w-100 text-center text-md-right pr-md-5">
                            ...
                            <h2 class="h4 font-size-sm text-uppercase font-w600 text-muted"><i class="fas fa-table"></i>
                                <span>التاريخ: {{$ticket->date_party}}</span> - الساعة: {{$ticket->hour_party}}</h2>
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        >
                            <div class="block-content block-content-full px-5 py-4">
                                ...
                                <a href="{{route('tickets.index')}}" class="btn btn-hero-primary"><i class="fa fa-arrow-right mr-1"></i> رجوع</a>
                                <a href="{{route('tickets.edit', $ticket->id)}}" class="btn btn-hero-primary"><i class="fa fa-pen mr-1"></i> تعديل</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 order-md-0">
                ...
                <div class="block">
                    ...
                    <div class="js-slider slick-nav-black slick-nav-hover responsive" dir="ltr" data-dots="true" data-arrows="true" data-slides-to-show="2" data-center-mode="true" data-autoplay="true" data-autoplay-speed="3000">
                        <div class="image">
                            <img class="img-fluid" src="{{asset('admin/assets')}}/media/photos/photo15.jpg" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{asset('admin/assets')}}/media/photos/photo16.jpg" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{asset('admin/assets')}}/media/photos/photo17.jpg" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{asset('admin/assets')}}/media/photos/photo18.jpg" alt="">
                        </div>
                        <div>
                            <img class="img-fluid" src="{{asset('admin/assets')}}/media/photos/photo19.jpg" alt="">
                        </div>
                    </div>
                </div>
