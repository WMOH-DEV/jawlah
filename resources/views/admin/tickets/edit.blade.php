                                        ...
                                        <select name="category_id" id="category_id"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                        @if ($ticket->category_id === $category->id) selected @endif>{{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </td>
                                        ...
                                        <select name="city_id" id="city_id"
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}"
                                                        @if ($ticket->city_id === $city->id) selected @endif>{{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr style="font-size: 0.9rem">
                                    ...
                                    <td class="font-w600">
                                        <select name="age" id="age" class="js-select2 form-control js-select2-enabled">
                                            <option value="بالغين" @if ($ticket->age === 'بالغين') selected @endif>
                                                بالغين
                                            </option>
                                            <option value="أطفال" @if ($ticket->age === 'أطفال') selected @endif>أطفال
                                            </option>
                                        </select>
                                    </td>
                                </tr>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <input
                                                    ...
                                                    value="{{ $ticket->price_without_vat }}" id="price_without_vat"
                                                    placeholder="00,00">
                                            </div>
                                            <div class="col-4">
                                    ...
                                    <td class="font-w600">
                                        <select
                                            ...
                                            @foreach ($merchants as $merchant)
                                                <option value="{{$merchant->id}}" @if($merchant->id == $ticket->user->id) selected @endif>{{$merchant->name}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                    ...
                                    <td class="font-w600" colspan="2">
                                        <div class="text-center">
                                            <div class="custom-control custom-switch custom-control-inline custom-control-info">
                                                <input type="checkbox" class="custom-control-input" id="vat" name="vat"  {{$ticket->vat ? 'checked' : ''}}>
                                            ...
                                            <div class="custom-control custom-switch custom-control-inline custom-control-success">
                                                <input type="checkbox" class="custom-control-input" id="special" name="special" {{$ticket->special ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="special"> مميزة؟</label>
                                            </div>
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="photography" name="photography" {{$ticket->photography ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="photography">التصوير</label>
                                            </div>
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="food" name="food" {{$ticket->food ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="food">الطعام</label>
                                            </div>

                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="id_card" name="id_card" {{$ticket->id_card ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="id_card">الهوية</label>
                                            </div>

                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="trans" name="trans" {{$ticket->trans ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="trans">مواصلات</label>
                                            </div>

                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="guide" name="guide" {{$ticket->guide ? 'checked' : ''}}>
                                                <label class="custom-control-label" for="guide">مرشد سياحي</label>
                                            </div>

                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="safety" name="safety" {{$ticket->safety ? 'checked' : ''}}>
