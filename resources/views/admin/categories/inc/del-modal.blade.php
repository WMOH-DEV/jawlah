    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        ...
        <div class="block-content">
          <p class="text-center" style="font-size: 1.1rem">هل أنت متأكد من حذف هذا التصنيف ؟</p>
        </div>
        <form action="{{route('categories.destroy', $cat->id)}}" method="post" class="m-0">
