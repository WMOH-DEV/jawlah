        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">فئة جديدة</h3>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-alt unset" id="name"
                                       value="{{old('name')}}"
                                       name="name" placeholder="اسم الفئة الجديدة">
                            </div>
                            <!-- image -->
                            <div class="form-group">
                                ...
                                <input type="file" class="unset form-control dropify" id="image"
                                       ...
                                       data-height="70"
                                       name="image">
                                <span class="text-danger" style="font-size: 0.7rem">* غير إلزامي - الحجم المسموح هو 500 كيلوبايت - الملفات المسموح بها JPG, PNG</span>
