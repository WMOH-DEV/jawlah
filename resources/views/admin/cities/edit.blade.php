                            ...
                            <table class="table table-bordered table-striped table-hover table-vcenter no-footer">
                                <tbody>
                                    <tr style="font-size: 0.9rem">
                                        ...
                                        <td class="font-w600">
                                            <input class="form-control  unset" name="name" type="text"
                                                value="{{ $city->name }}" id="name" placeholder="يكتب اسم المدينة">
                                        </td>
                                    </tr>
                                    <tr style="font-size: 0.9rem">
                                        <th scope="row">
                                        ...
                                        <td class="font-w600">
                                            <textarea type="text"
                                                ...
                                                id="desc-maxlength150" rows="3" data-always-show="true" name="desc"
                                                placeholder="الوصف هنا ..." maxlength="150">{{ $city->desc }}</textarea>
                                        </td>
                                    </tr>
                                    <tr style="font-size: 0.9rem">
                                        <th scope="row">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <input type="file" name="image" class="form-group dropify"
                                                        data-height="70">
                                                    <span class="text-danger" style="font-size: 0.7rem">الحجم المسموح هو
                                                        1024 كيلوبايت - الملفات المسموح بها JPG, PNG</span>
                                                </div>
                                                <div class="col-6">
                                                    <img src="{{ asset("uploads/$city->image") }}" alt="{{ $city->name }}"
                                                        style="height: 85px">
                                                </div>
                                            </div>
                                        </td>
