                    ...
                    <table
                        ...
                        @foreach ($cities as $index => $city)
                            <tr>
                                ...
                                <td class="text-center"><img src="{{asset('uploads')}}/{{$city->image}}"
                                                             alt="{{$city->name}}" style="height: 50px; margin:auto">
                                </td>
                                <td class="text-center">{{$city->name}}</td>
                                <td class="text-center"
                                    style="width:40%">{{strlen(utf8_decode($city->desc)) >= 70 ? mb_substr($city->desc, 0, 70,'utf-8').'...': $city->desc}}</td>
