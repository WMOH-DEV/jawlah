...
@section('content')
  ...
  <!-- Page Content -->
  <div class="bg-image rtl-support rtl" style="background-image: url('{{asset('admin/assets')}}/media/photos/photo19@2x.jpg');">
          ...
          <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white">
            ...
            <div class="mb-2 text-center">
              <a class="link-fx font-w700 font-size-h1" href="/">
                <span class="text-dark">Traveler</span><span class="text-primary">guide</span>
              </a>
